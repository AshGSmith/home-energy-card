 ...
 */
const ne = globalThis, _e = ne.ShadowRoot && (ne.ShadyCSS === void 0 || ne.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, me = Symbol(), Oe = /* @__PURE__ */ new WeakMap();
let Ze = class {
  constructor(e, t, i) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: nt, defineProperty: at, getOwnPropertyDescriptor: rt, getOwnPropertyNames: lt, getOwnPropertySymbols: ct, getPrototypeOf: ht } = Object, T = globalThis, Ne = T.trustedTypes, dt = Ne ? Ne.emptyScript : "", de = T.reactiveElementPolyfillSupport, G = (s, e) => s, ae = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? dt : null;
      break;
  ...
  return t;
} }, ve = (s, e) => !nt(s, e), De = { attribute: !0, type: String, converter: ae, reflect: !1, useDefault: !1, hasChanged: ve };
...
let M = class extends HTMLElement {
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const r = i.getPropertyOptions(o), c = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((n = r.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? r.converter : ae;
      this._$Em = o;
  ...
  requestUpdate(e, t, i, o = !1, n) {
    ...
    if (e !== void 0) {
      ...
      if (o === !1 && (n = this[e]), i ?? (i = r.getPropertyOptions(e)), !((i.hasChanged ?? ve)(n, t) || i.useDefault && i.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(r._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
const ft = (s, e) => {
  ...
  let o, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", a = F;
  for (let r = 0; r < t; r++) {
    const c = s[r];
    let h, u, d = -1, _ = 0;
    for (; _ < c.length && (a.lastIndex = _, u = a.exec(c), u !== null); ) _ = a.lastIndex, a === F ? u[1] === "!--" ? a = Me : u[1] !== void 0 ? a = je : u[2] !== void 0 ? (Je.test(u[2]) && (o = RegExp("</" + u[2], "g")), a = P) : u[3] !== void 0 && (a = P) : a === P ? u[0] === ">" ? (a = o ?? F, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, h = u[1], a = u[3] === void 0 ? P : u[3] === '"' ? Le : Ie) : a === Le || a === Ie ? a = P : a === Me || a === je ? a = F : (a = P, o = void 0);
    const m = a === P && s[r + 1].startsWith("/>") ? " " : "";
    n += a === F ? c + pt : d >= 0 ? (i.push(h), c.slice(0, d) + qe + c.slice(d) + A + m) : c + A + (d === -2 ? r : m);
  }
    ...
    for (; (o = z.nextNode()) !== null && c.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const d of o.getAttributeNames()) if (d.endsWith(qe)) {
          const _ = u[a++], m = o.getAttribute(d).split(A), p = /([.?@])?(.*)/.exec(_);
          c.push({ type: 1, index: n, name: p[2], strings: m, ctor: p[1] === "." ? gt : p[1] === "?" ? _t : p[1] === "@" ? mt : le }), o.removeAttribute(d);
        } else d.startsWith(A) && (c.push({ type: 6, index: n }), o.removeAttribute(d));
        if (Je.test(o.tagName)) {
          const d = o.textContent.split(A), _ = d.length - 1;
          if (_ > 0) {
            o.textContent = re ? re.emptyScript : "";
            for (let m = 0; m < _; m++) o.append(d[m], q()), z.nextNode(), c.push({ type: 2, index: ++n });
            o.append(d[_], q());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ye) c.push({ type: 2, index: n });
      else {
        let d = -1;
...
function L(s, e, t = s, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== n && ((r = o == null ? void 0 : o._$AO) == null || r.call(o, !1), n === void 0 ? o = void 0 : (o = new n(s), o._$AT(s, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = L(s, o._$AS(s, e.values), o, i)), e;
}
class yt {
  constructor(e, t) {
  ...
  u(e) {
    ...
    z.currentNode = o;
    let n = z.nextNode(), a = 0, r = 0, c = i[0];
    for (; c !== void 0; ) {
      if (a === c.index) {
        let h;
        c.type === 2 ? h = new X(n, n.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (h = new vt(n, this, e)), this._$AV.push(h), c = i[++r];
      }
      a !== (c == null ? void 0 : c.index) && (n = z.nextNode(), a++);
    }
...
class X {
  ...
  $(e) {
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(t);
      ...
      const a = new yt(o, this), r = a.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const n of e) o === t.length ? t.push(i = new X(this.O(q()), this.O(q()), this, this.options)) : i = t[o], i._$AI(n), o++;
...
class le {
  ...
  constructor(e, t, i, o, n) {
    this.type = 1, this._$AH = f, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = n, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = f;
  }
  _$AI(e, t = this, i, o) {
    const n = this.strings;
    let a = !1;
    if (n === void 0) e = L(this, e, t, 0), a = !Y(e) || e !== this._$AH && e !== I, a && (this._$AH = e);
    else {
      const r = e;
      let c, h;
      for (e = n[0], c = 0; c < n.length - 1; c++) h = L(this, r[i + c], t, c), h === I && (h = this._$AH[c]), a || (a = !Y(h) || h !== this._$AH[c]), h === f ? e = f : e !== f && (e += (h ?? "") + n[c + 1]), this._$AH[c] = h;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
class mt extends le {
  ...
  _$AI(e, t = this) {
    ...
    const i = this._$AH, o = e === f && i !== f || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, n = e !== f && (i === f || o);
...
const $t = (s, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new X(e.insertBefore(q(), n), n, void 0, t ?? {});
  }
  return o._$AI(s), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bt = { attribute: !0, type: String, converter: ae, reflect: !1, hasChanged: ve }, wt = (s = bt, e, t) => {
  ...
  if (n === void 0 && globalThis.litPropertyMetadata.set(o, n = /* @__PURE__ */ new Map()), i === "setter" && ((s = Object.create(s)).wrapped = !0), n.set(t.name, s), i === "accessor") {
    ...
    return { set(r) {
      ...
      e.set.call(this, r), this.requestUpdate(a, c, s, !0, r);
    }, init(r) {
      return r !== void 0 && this.C(a, void 0, s, r), r;
    } };
  }
  if (i === "setter") {
    const { name: a } = t;
    return function(r) {
      const c = this[a];
      e.call(this, r), this.requestUpdate(a, c, s, !0, r);
    };
  }
  throw Error("Unsupported decorator location: " + i);
};
function $(s) {
  return (e, t) => typeof t == "object" ? wt(s, e, t) : ((i, o, n) => {
...
function xt(s, e, t) {
  ...
  ), a = ["Octopus Energy"], r = {}, c = {}, h = w(
    n,
    s,
    se(["_current_rate"], ["export", "accumulative"]),
    t
  );
  h && (r.rate_entity = h, a.push("rate"));
  const u = w(
    n,
    s,
  ...
  d && (r.slots_entity = d, a.push("slots"));
  const _ = w(
  ...
  _ && (r.dispatches_entity = _, a.push("dispatching")), Object.keys(r).length && (c.octopus = r);
  const m = w(
    n,
    s,
  ...
  m && (c.power_import = m, a.push("import power"));
  const p = w(
    n,
    s,
  ...
  p && (c.power_export = p, a.push("export power"));
  const y = w(
    n,
    s,
  ...
  y && (c.daily_usage = y, a.push("daily import"));
  const x = w(
    n,
    s,
  ...
  return x && (c.daily_export = x, a.push("daily export")), { integration_type: "octopus", entity_types: { grid: c }, summary: a };
}
function Et(s, e, t) {
  ...
  const n = i.length > 0 ? i.map((p) => p.entity_id) : Object.keys(s).filter((p) => p.includes("powerwall") || p.includes("tesla")), a = n.filter((p) => p.includes("powerwall")), r = n.filter((p) => !p.includes("powerwall")), c = ["Tesla"], h = {};
  if (a.length > 0) {
    const p = {}, y = w(
      a,
      s,
...
function St(s) {
  var c, h;
  const e = s, t = e.states ?? {}, i = e.entities ?? {}, o = /* @__PURE__ */ new Set(), n = Et(t, i, o), a = xt(t, i, o), r = {
    integration_type: "manual",
    entity_types: {},
    summary: []
  };
  if (n && (r.integration_type = "tesla", Object.assign(r.entity_types, n.entity_types), r.summary.push(...n.summary ?? [])), a) {
    if (r.integration_type !== "tesla" && (r.integration_type = "octopus"), (c = a.entity_types) != null && c.grid) {
...
function kt(s, e, t = !1) {
  ...
  for (const [a, r] of Object.entries(e.entity_types)) {
    const c = o[a] ?? {}, h = { ...c };
...
var At = Object.defineProperty, Tt = Object.getOwnPropertyDescriptor, te = (s, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? Tt(e, t) : e, n = s.length - 1, a; n >= 0; n--)
...
let H = class extends E {
  ...
  _setOctopus(s, e, t) {
    var r;
    const i = { ...((r = this.config) == null ? void 0 : r.entity_types) ?? {} }, o = i[s] ?? {}, n = { ...o.octopus, [e]: t || void 0 }, a = Object.values(n).some(Boolean);
    i[s] = a ? { ...o, octopus: n } : (({ octopus: c, ...h }) => h)(o), this._set("entity_types", i);
  }
  _runAutoDetect() {
    if (!this.hass) {
    ...
    this._dispatch(kt(this.config, s, !1)), this._detectStatus = `Detected: ${s.summary.join(", ")}`, this._detectIsError = !1;
  }
  render() {
    var h, u, d, _, m, p, y, x, b;
    if (!this.config) return f;
    const s = ((h = this.config.entity_types) == null ? void 0 : h.grid) ?? {}, e = ((u = this.config.entity_types) == null ? void 0 : u.solar) ?? {}, t = ((d = this.config.entity_types) == null ? void 0 : d.battery) ?? {}, i = ((_ = this.config.entity_types) == null ? void 0 : _.home) ?? {}, o = ((m = this.config.entity_types) == null ? void 0 : m.ev) ?? {}, n = ((p = this.config.entity_types) == null ? void 0 : p.custom_1) ?? {}, a = this.config.live_data ?? {}, r = this.config.system ?? {}, c = this.config.display ?? {};
    return g`
      <div class="section">
      ...
      <div class="section">
        ...
        <ha-entity-picker label="Grid Import Power" .hass=${this.hass} .value=${s.power_import ?? ""} @value-changed=${(l) => this._setEntityType("grid", "power_import", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Grid Export Power" .hass=${this.hass} .value=${s.power_export ?? ""} @value-changed=${(l) => this._setEntityType("grid", "power_export", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Grid Combined Power" .hass=${this.hass} .value=${s.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("grid", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Grid Daily Usage" .hass=${this.hass} .value=${s.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("grid", "daily_usage", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>Grid Show when idle</span>
          <ha-switch .checked=${s.show_zero !== !1} @change=${(l) => this._setEntityType("grid", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="Grid Zero Tolerance" type="number" min="0" .value=${s.zero_tolerance != null ? String(s.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("grid", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="Grid Label" .value=${s.label ?? ""} @change=${(l) => this._setEntityType("grid", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="Grid Colour" .value=${s.colour ?? ""} @change=${(l) => this._setEntityType("grid", "colour", l.target.value || void 0)}></ha-textfield>
        <ha-entity-picker label="Grid Octopus Rate Entity" .hass=${this.hass} .value=${((y = s.octopus) == null ? void 0 : y.rate_entity) ?? ""} @value-changed=${(l) => this._setOctopus("grid", "rate_entity", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Grid Octopus Cost Entity" .hass=${this.hass} .value=${((x = s.octopus) == null ? void 0 : x.cost_entity) ?? ""} @value-changed=${(l) => this._setOctopus("grid", "cost_entity", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Grid Octopus Slots Entity" .hass=${this.hass} .value=${((b = s.octopus) == null ? void 0 : b.slots_entity) ?? ""} @value-changed=${(l) => this._setOctopus("grid", "slots_entity", l.detail.value)}></ha-entity-picker>
      </div>

      <div class="section">
        <div class="heading">Solar</div>
        <ha-entity-picker label="Solar Combined Power" .hass=${this.hass} .value=${e.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("solar", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Solar Daily Usage" .hass=${this.hass} .value=${e.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("solar", "daily_usage", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>Solar Show when idle</span>
          <ha-switch .checked=${e.show_zero !== !1} @change=${(l) => this._setEntityType("solar", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="Solar Zero Tolerance" type="number" min="0" .value=${e.zero_tolerance != null ? String(e.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("solar", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="Solar Label" .value=${e.label ?? ""} @change=${(l) => this._setEntityType("solar", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="Solar Colour" .value=${e.colour ?? ""} @change=${(l) => this._setEntityType("solar", "colour", l.target.value || void 0)}></ha-textfield>
      </div>

      <div class="section">
        <div class="heading">Battery</div>
        <ha-entity-picker label="Battery State of Charge" .hass=${this.hass} .value=${t.soc ?? ""} @value-changed=${(l) => this._setEntityType("battery", "soc", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Battery Combined Power" .hass=${this.hass} .value=${t.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("battery", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Battery Daily Usage" .hass=${this.hass} .value=${t.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("battery", "daily_usage", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>Battery Show when idle</span>
          <ha-switch .checked=${t.show_zero !== !1} @change=${(l) => this._setEntityType("battery", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="Battery Zero Tolerance" type="number" min="0" .value=${t.zero_tolerance != null ? String(t.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("battery", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="Battery Label" .value=${t.label ?? ""} @change=${(l) => this._setEntityType("battery", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="Battery Colour" .value=${t.colour ?? ""} @change=${(l) => this._setEntityType("battery", "colour", l.target.value || void 0)}></ha-textfield>
      </div>

      <div class="section">
        <div class="heading">Home</div>
        <ha-entity-picker label="Home Combined Power" .hass=${this.hass} .value=${i.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("home", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Home Daily Usage" .hass=${this.hass} .value=${i.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("home", "daily_usage", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>Home Show when idle</span>
          <ha-switch .checked=${i.show_zero !== !1} @change=${(l) => this._setEntityType("home", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="Home Zero Tolerance" type="number" min="0" .value=${i.zero_tolerance != null ? String(i.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("home", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="Home Label" .value=${i.label ?? ""} @change=${(l) => this._setEntityType("home", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="Home Colour" .value=${i.colour ?? ""} @change=${(l) => this._setEntityType("home", "colour", l.target.value || void 0)}></ha-textfield>
      </div>

      <div class="section">
        <div class="heading">EV</div>
        <ha-entity-picker label="EV State of Charge" .hass=${this.hass} .value=${o.soc ?? ""} @value-changed=${(l) => this._setEntityType("ev", "soc", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="EV Combined Power" .hass=${this.hass} .value=${o.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("ev", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="EV Daily Usage" .hass=${this.hass} .value=${o.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("ev", "daily_usage", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>EV Show when idle</span>
          <ha-switch .checked=${o.show_zero !== !1} @change=${(l) => this._setEntityType("ev", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="EV Zero Tolerance" type="number" min="0" .value=${o.zero_tolerance != null ? String(o.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("ev", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="EV Label" .value=${o.label ?? ""} @change=${(l) => this._setEntityType("ev", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="EV Colour" .value=${o.colour ?? ""} @change=${(l) => this._setEntityType("ev", "colour", l.target.value || void 0)}></ha-textfield>
      </div>

      <div class="section">
        <div class="heading">Custom</div>
        <ha-entity-picker label="Custom Import Power" .hass=${this.hass} .value=${n.power_import ?? ""} @value-changed=${(l) => this._setEntityType("custom_1", "power_import", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Custom Export Power" .hass=${this.hass} .value=${n.power_export ?? ""} @value-changed=${(l) => this._setEntityType("custom_1", "power_export", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Custom Combined Power" .hass=${this.hass} .value=${n.power_combined ?? ""} @value-changed=${(l) => this._setEntityType("custom_1", "power_combined", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Custom Daily Usage" .hass=${this.hass} .value=${n.daily_usage ?? ""} @value-changed=${(l) => this._setEntityType("custom_1", "daily_usage", l.detail.value)}></ha-entity-picker>
        <ha-entity-picker label="Custom State of Charge" .hass=${this.hass} .value=${n.soc ?? ""} @value-changed=${(l) => this._setEntityType("custom_1", "soc", l.detail.value)}></ha-entity-picker>
        <div class="switch-row">
          <span>Custom Show when idle</span>
          <ha-switch .checked=${n.show_zero !== !1} @change=${(l) => this._setEntityType("custom_1", "show_zero", l.target.checked)}></ha-switch>
        </div>
        <ha-textfield label="Custom Zero Tolerance" type="number" min="0" .value=${n.zero_tolerance != null ? String(n.zero_tolerance) : ""} @change=${(l) => {
      const v = l.target.value;
      this._setEntityType("custom_1", "zero_tolerance", v !== "" ? Number(v) : void 0);
    }}></ha-textfield>
        <ha-textfield label="Custom Label" .value=${n.label ?? ""} @change=${(l) => this._setEntityType("custom_1", "label", l.target.value || void 0)}></ha-textfield>
        <ha-textfield label="Custom Colour" .value=${n.colour ?? ""} @change=${(l) => this._setEntityType("custom_1", "colour", l.target.value || void 0)}></ha-textfield>
      </div>

      <div class="section">
        <div class="heading">Live Data</div>
        <ha-textfield label="Refresh interval (s)" type="number" min="1" .value=${String(a.refresh_interval ?? 5)} @change=${(l) => this._set("live_data", { ...a, refresh_interval: Number(l.target.value) })}></ha-textfield>
        <div class="switch-row">
          <span>Show live badge</span>
          <ha-switch .checked=${a.show_live_badge ?? !0} @change=${(l) => this._set("live_data", { ...a, show_live_badge: l.target.checked })}></ha-switch>
        </div>
      </div>

      <div class="section">
        <div class="heading">System</div>
        <ha-textfield label="Energy day reset hour (0–23)" type="number" min="0" max="23" .value=${String(r.energy_date_reset ?? 0)} @change=${(l) => this._set("system", { ...r, energy_date_reset: Number(l.target.value) })}></ha-textfield>
        <ha-select label="Time format" .value=${r.time_format ?? "24h"} @value-changed=${(l) => this._set("system", { ...r, time_format: l.detail.value })}>
      ...
      <div class="section">
        ...
        <ha-textfield label="Decimal places" type="number" min="0" max="4" .value=${String(c.decimal_places ?? 1)} @change=${(l) => this._set("display", { ...c, decimal_places: Number(l.target.value) })}></ha-textfield>
        <ha-select label="Unit" .value=${c.unit ?? "auto"} @value-changed=${(l) => this._set("display", { ...c, unit: l.detail.value })}>
        ...
        <div class="switch-row">
          <span>Animation</span>
          <ha-switch .checked=${c.animation ?? !0} @change=${(l) => this._set("display", { ...c, animation: l.target.checked })}></ha-switch>
        </div>
        <div class="switch-row">
          <span>Dynamic animation speed</span>
          <ha-switch .checked=${c.dynamic_animation_speed ?? !1} @change=${(l) => this._set("display", { ...c, dynamic_animation_speed: l.target.checked })}></ha-switch>
        </div>
      </div>
    `;
  }
...
var Ct = Object.defineProperty, Pt = Object.getOwnPropertyDescriptor, ce = (s, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? Pt(e, t) : e, n = s.length - 1, a; n >= 0; n--)
    (a = s[n]) && (o = (i ? a(e, t, o) : a(o)) || o);
...
let R = class extends E {
  ...
  render() {
    var y, x, b, l, v, Se, ke, Ae, Te, Ce, Pe;
    if (!this.config) return f;
    const s = ((y = this.hass) == null ? void 0 : y.states) ?? {}, e = this.config.entity_types ?? {}, t = ((x = this.config.display) == null ? void 0 : x.decimal_places) ?? 1, i = this.config.tariff_entity ? (b = s[this.config.tariff_entity]) == null ? void 0 : b.state : null, o = i && i !== "unavailable" && i !== "unknown" ? Ot(i) : null, n = ie(s, (l = e.solar) == null ? void 0 : l.daily_usage), a = ie(s, (v = e.home) == null ? void 0 : v.daily_usage), r = ie(s, (Se = e.grid) == null ? void 0 : Se.daily_usage), c = ie(s, (ke = e.grid) == null ? void 0 : ke.daily_export), h = !!((Ae = e.solar) != null && Ae.daily_usage), u = !!((Te = e.home) != null && Te.daily_usage), d = !!((Ce = e.grid) != null && Ce.daily_usage), _ = !!((Pe = e.grid) != null && Pe.daily_export), m = d || _, p = h || u || m;
    return g`
      <div class="header">
...
var zt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, C = (s, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? Nt(e, t) : e, n = s.length - 1, a; n >= 0; n--)
    (a = s[n]) && (o = (i ? a(e, t, o) : a(o)) || o);
...
var Ut = Object.defineProperty, Mt = Object.getOwnPropertyDescriptor, U = (s, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? Mt(e, t) : e, n = s.length - 1, a; n >= 0; n--)
    (a = s[n]) && (o = (i ? a(e, t, o) : a(o)) || o);
...
function Rt(s) {
  ...
  for (let o = 0; o < 24; o++) {
    ...
    for (let h = 0; h < s.length; h++) {
      const u = new Date(s[h].last_changed).getTime(), d = h + 1 < s.length ? new Date(s[h + 1].last_changed).getTime() : e, _ = Math.max(u, n), m = Math.min(d, a);
      if (m <= _) continue;
...
let k = class extends E {
  ...
  async _loadHistory() {
    ...
    if (!(!e || !this.hass)) {
      ...
      try {
        const o = /* @__PURE__ */ new Date(), a = `history/period/${new Date(o.getTime() - 864e5).toISOString()}?filter_entity_id=${e}&minimal_response=true&no_attributes=true&end_time=${o.toISOString()}`, r = await this.hass.callApi("GET", a);
  ...
  _sectionPower(s) {
    var o, n, a, r, c;
    const e = ((n = (o = this.config) == null ? void 0 : o.display) == null ? void 0 : n.decimal_places) ?? 1, t = ((r = (a = this.config) == null ? void 0 : a.display) == null ? void 0 : r.unit) ?? "auto", i = ((c = Lt[this.nodeType]) == null ? void 0 : c[s.direction]) ?? "";
    return g`
      <div class="section">
  ...
  _sectionDaily(s) {
    var a, r, c;
    const e = ((a = this.hass) == null ? void 0 : a.states) ?? {}, t = ((c = (r = this.config) == null ? void 0 : r.display) == null ? void 0 : c.decimal_places) ?? 1, i = this.nodeType === "solar" ? "Production" : this.nodeType === "grid" ? "Import" : this.nodeType === "battery" || this.nodeType === "ev" ? "Charged" : "Usage", o = this.nodeType === "battery" ? "Discharged" : this.nodeType === "ev" ? "Discharged (V2H)" : "Export", n = [];
    return s.daily_usage && n.push([i, Fe(Ve(e, s.daily_usage), t)]), s.daily_export && n.push([o, Fe(Ve(e, s.daily_export), t)]), n.length ? g`
      <div class="section">
  ...
  _sectionOctopus(s) {
    var p;
    const e = ((p = this.hass) == null ? void 0 : p.states) ?? {}, t = s.rate_entity ? e[s.rate_entity] : null, i = s.cost_entity ? e[s.cost_entity] : null, o = s.slots_entity ? e[s.slots_entity] : null, n = t == null ? void 0 : t.state, a = (t == null ? void 0 : t.attributes.unit_of_measurement) ?? "p/kWh", r = i == null ? void 0 : i.state, c = (i == null ? void 0 : i.attributes.unit_of_measurement) ?? "£", h = (o == null ? void 0 : o.attributes.rates) ?? (o == null ? void 0 : o.attributes.upcoming_interval_rates) ?? (o == null ? void 0 : o.attributes.today_rates) ?? [], u = Date.now(), d = h.filter((y) => new Date(y.end ?? y.end_time ?? 0).getTime() > u).slice(0, 6), _ = n && n !== "unavailable" && n !== "unknown", m = r && r !== "unavailable" && r !== "unknown";
    return !_ && !m && !d.length ? f : g`
      <div class="section">
        ...
        ${d.length ? g`
          ...
          ${d.map((y) => {
      const x = y.start ?? y.start_time ?? "", b = y.end ?? y.end_time ?? "", l = y.value_inc_vat ?? y.rate_inc_vat ?? y.value ?? 0, v = Wt(l);
      return g`
              <div class="slot">
                <span class="slot-dot" style="background:${v};"></span>
                <span class="slot-time">${Ge(x)}–${Ge(b)}</span>
                <span class="slot-rate" style="color:${v};">${(+l).toFixed(2)}p</span>
              </div>
            `;
    })}
        ` : f}
...
var Gt = Object.defineProperty, Kt = Object.getOwnPropertyDescriptor, he = (s, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? Kt(e, t) : e, n = s.length - 1, a; n >= 0; n--)
    (a = s[n]) && (o = (i ? a(e, t, o) : a(o)) || o);
...
let B = class extends E {
  ...
  _svgLines() {
    ...
    return Z`
      ...
      const r = this._flowInfo(a), [c, h, u, d] = Yt[a], _ = r.direction === "idle", m = r.direction === "from-home", p = Zt(r.magnitude, s && !_), y = [
        "flow-line",
        m ? "reverse" : "",
        _ ? "idle" : "",
        e ? "" : "paused"
  ...
  _node(s, e, t = !1) {
    var r, c, h;
    const i = s === "home" ? !0 : this._isVisible(s), o = ((c = (r = this.config) == null ? void 0 : r.entity_types) == null ? void 0 : c[s]) ?? {}, n = ((h = this.config) == null ? void 0 : h.display) ?? {}, a = this._flowInfo(s);
    return g`
      <hec-energy-node
        class="${e}${i ? "" : " hidden"}"
        .type=${s}
  ...
  _customNode(s, e, t) {
    var r, c, h;
    const i = this._isVisible(s), o = ((c = (r = this.config) == null ? void 0 : r.entity_types) == null ? void 0 : c[s]) ?? {}, n = ((h = this.config) == null ? void 0 : h.display) ?? {}, a = this._flowInfo(s);
    return g`
      <hec-energy-node
