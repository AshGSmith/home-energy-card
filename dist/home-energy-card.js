...
const li = (e) => new Js(typeof e == "string" ? e : e + "", void 0, de), $t = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: di, defineProperty: ui, getOwnPropertyDescriptor: pi, getOwnPropertyNames: fi, getOwnPropertySymbols: yi, getPrototypeOf: gi } = Object, X = globalThis, Ss = X.trustedTypes, mi = Ss ? Ss.emptyScript : "", ee = X.reactiveElementPolyfillSupport, kt = (e, t) => e, Zt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? mi : null;
      break;
  ...
  return s;
} }, ue = (e, t) => !di(e, t), As = { attribute: !0, type: String, converter: Zt, reflect: !1, useDefault: !1, hasChanged: ue };
...
vt.elementStyles = [], vt.shadowRootOptions = { mode: "open" }, vt[kt("elementProperties")] = /* @__PURE__ */ new Map(), vt[kt("finalized")] = /* @__PURE__ */ new Map(), ee == null || ee({ ReactiveElement: vt }), (X.reactiveElementVersions ?? (X.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pt = globalThis, Ts = (e) => e, Xt = Pt.trustedTypes, ks = Xt ? Xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Qs = "$lit$", Z = `lit$${Math.random().toFixed(9).slice(2)}$`, ti = "?" + Z, _i = `<${ti}>`, ft = document, Ot = () => ft.createComment(""), zt = (e) => e === null || typeof e != "object" && typeof e != "function", pe = Array.isArray, vi = (e) => pe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", se = `[ 	
\f\r]`, At = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ps = /-->/g, Ms = />/g, at = RegExp(`>|${se}(?:([^\\s"'>=/]+)(${se}*=${se}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ls = /'/g, Os = /"/g, ei = /^(?:script|style|textarea|title)$/i, si = (e) => (t, ...s) => ({ _$litType$: e, strings: t, values: s }), w = si(1), Mt = si(2), yt = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), zs = /* @__PURE__ */ new WeakMap(), dt = ft.createTreeWalker(ft, 129);
function ii(e, t) {
...
const bi = (e, t) => {
  ...
  for (let a = 0; a < s; a++) {
    const c = e[a];
    let d, p, u = -1, g = 0;
    for (; g < c.length && (r.lastIndex = g, p = r.exec(c), p !== null); ) g = r.lastIndex, r === At ? p[1] === "!--" ? r = Ps : p[1] !== void 0 ? r = Ms : p[2] !== void 0 ? (ei.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = at) : p[3] !== void 0 && (r = at) : r === at ? p[0] === ">" ? (r = o ?? At, u = -1) : p[1] === void 0 ? u = -2 : (u = r.lastIndex - p[2].length, d = p[1], r = p[3] === void 0 ? at : p[3] === '"' ? Os : Ls) : r === Os || r === Ls ? r = at : r === Ps || r === Ms ? r = At : (r = at, o = void 0);
    const y = r === at && e[a + 1].startsWith("/>") ? " " : "";
    n += r === At ? c + _i : u >= 0 ? (i.push(d), c.slice(0, u) + Qs + c.slice(u) + Z + y) : c + Z + (u === -2 ? a : y);
  }
...
class Nt {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, r = 0;
    const a = t.length - 1, c = this.parts, [d, p] = bi(t, s);
    ...
    for (; (o = dt.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const u of o.getAttributeNames()) if (u.endsWith(Qs)) {
          const g = p[r++], y = o.getAttribute(u).split(Z), f = /([.?@])?(.*)/.exec(g);
          c.push({ type: 1, index: n, name: f[2], strings: y, ctor: f[1] === "." ? $i : f[1] === "?" ? xi : f[1] === "@" ? Ei : te }), o.removeAttribute(u);
        } else u.startsWith(Z) && (c.push({ type: 6, index: n }), o.removeAttribute(u));
        if (ei.test(o.tagName)) {
          const u = o.textContent.split(Z), g = u.length - 1;
          if (g > 0) {
            o.textContent = Xt ? Xt.emptyScript : "";
            for (let y = 0; y < g; y++) o.append(u[y], Ot()), dt.nextNode(), c.push({ type: 2, index: ++n });
            o.append(u[g], Ot());
          }
        }
        ...
        let u = -1;
        for (; (u = o.data.indexOf(Z, u + 1)) !== -1; ) c.push({ type: 7, index: n }), u += Z.length - 1;
      }
      n++;
    }
  }
...
class wi {
  ...
  u(t) {
    const { el: { content: s }, parts: i } = this._$AD, o = ((t == null ? void 0 : t.creationScope) ?? ft).importNode(s, !0);
    dt.currentNode = o;
    let n = dt.nextNode(), r = 0, a = 0, c = i[0];
    for (; c !== void 0; ) {
      if (r === c.index) {
        let d;
        c.type === 2 ? d = new xt(n, n.nextSibling, this, t) : c.type === 1 ? d = new c.ctor(n, c.name, c.strings, this, t) : c.type === 6 && (d = new Ci(n, this, t)), this._$AV.push(d), c = i[++a];
      }
      r !== (c == null ? void 0 : c.index) && (n = dt.nextNode(), r++);
    }
    return dt.currentNode = ft, o;
  }
  p(t) {
    let s = 0;
...
class xt {
  ...
  _$AI(t, s = this) {
    t = wt(this, t, s), zt(t) ? t === v || t == null || t === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : t !== this._$AH && t !== yt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : vi(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== v && zt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ft.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(s);
      ...
      const r = new wi(o, this), a = r.u(this.options);
...
class te {
  ...
  _$AI(t, s = this, i, o) {
    ...
    let r = !1;
    if (n === void 0) t = wt(this, t, s, 0), r = !zt(t) || t !== this._$AH && t !== yt, r && (this._$AH = t);
    else {
      const a = t;
      let c, d;
      for (t = n[0], c = 0; c < n.length - 1; c++) d = wt(this, a[i + c], s, c), d === yt && (d = this._$AH[c]), r || (r = !zt(d) || d !== this._$AH[c]), d === v ? t = v : t !== v && (t += (d ?? "") + n[c + 1]), this._$AH[c] = d;
    }
    r && !o && this.j(t);
  }
  j(t) {
...
class Ei extends te {
  ...
  _$AI(t, s = this) {
    if ((t = wt(this, t, s, 0) ?? v) === yt) return;
...
const Si = { I: xt }, ie = Pt.litHtmlPolyfillSupport;
...
var Xs;
j._$litElement$ = !0, j.finalized = !0, (Xs = pt.litElementHydrateSupport) == null || Xs.call(pt, { LitElement: j });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ti = { attribute: !0, type: String, converter: Zt, reflect: !1, hasChanged: ue }, ki = (e = Ti, t, s) => {
...
function x(e) {
  return (t, s) => typeof s == "object" ? ki(e, t, s) : ((i, o, n) => {
...
function Li(e) {
  var c, d;
  const t = e, s = t.states ?? {}, i = t.entities ?? {}, o = /* @__PURE__ */ new Set(), n = Mi(s, i, o), r = Pi(s, i, o), a = {
...
function Oi(e, t, s = !1) {
  ...
  for (const [r, a] of Object.entries(t.entity_types)) {
    ...
    for (const [p, u] of Object.entries(a))
      u !== void 0 && (s || !c[p]) && (d[p] = u);
    n[r] = d;
  }
  return i.entity_types = n, i;
}
const Jt = ["grid", "solar", "battery", "home", "ev"], zi = "custom_", Wt = 4;
function Hs(e) {
...
var Hi = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, me = (e, t, s, i) => {
...
let Ht = class extends j {
  ...
  render() {
    var i, o, n, r, a, c, d, p, u, g, y, f, m, b, _, S, k, C, T, P, O, z, H, R, D, V, F, Ct, Q, Y, tt, et, st, it, ot, K, W, nt, St, $, M, I, B, _t, ve, be, we, $e, xe, Ee, Ce, Se, Ae, Te, ke, Pe, Me, Le, Oe, ze, Ne, He, Re, De, Ie, Ue, Ve, Fe, Be, je, Ge, Ke, We, qe, Ye, Ze, Xe, Je, Qe, ts, es, ss, is, os, ns, rs, as, cs, ls, hs, ds, us, ps, fs, ys, gs, ms, _s, vs, bs, ws, $s;
      ...
      <ha-expansion-panel header="Battery">
        <div class="section-body">
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((_t = (B = this.config.entity_types) == null ? void 0 : B.battery) == null ? void 0 : _t.soc) ?? ""}
            @value-changed=${(h) => {
      var l;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
...
var Di = Object.defineProperty, Ii = Object.getOwnPropertyDescriptor, It = (e, t, s, i) => {
...
let gt = class extends j {
  ...
  render() {
    ...
    if (!this.config) return v;
    const e = ((_ = this.hass) == null ? void 0 : _.states) ?? {}, t = this.config.entity_types ?? {}, s = ((S = this.config.display) == null ? void 0 : S.decimal_places) ?? 1, i = this.config.tariff_entity ? (k = e[this.config.tariff_entity]) == null ? void 0 : k.state : null, o = i && i !== "unavailable" && i !== "unknown" ? Ui(i) : null, n = Bt(e, (C = t.solar) == null ? void 0 : C.daily_usage), r = Bt(e, (T = t.home) == null ? void 0 : T.daily_usage), a = Bt(e, (P = t.grid) == null ? void 0 : P.daily_usage), c = Bt(e, (O = t.grid) == null ? void 0 : O.daily_export), d = !!((z = t.solar) != null && z.daily_usage), p = !!((H = t.home) != null && H.daily_usage), u = !!((R = t.grid) != null && R.daily_usage), g = !!((D = t.grid) != null && D.daily_export), y = u || g, f = d || p || y, m = this.showValues && f, b = this.showTitle || o;
    return !b && !m ? v : w`
      <div class="header">
...
It([
  x({ type: Boolean })
], gt.prototype, "showTitle", 2);
It([
  x({ type: Boolean })
], gt.prototype, "showValues", 2);
gt = It([
  Et("hec-card-header")
], gt);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vi = { CHILD: 2 }, Fi = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Bi = class {
  constructor(t) {
  }
  get _$AU() {
...
const { I: ji } = Si, Ds = (e) => e, Is = () => document.createComment(""), Tt = (e, t, s) => {
  ...
  return s;
}, ct = (e, t, s = e) => (e._$AI(t, s), e), Gi = {}, Ki = (e, t = Gi) => e._$AH = t, Wi = (e) => e._$AH, ne = (e) => {
...
const Us = (e, t, s) => {
  ...
  update(e, [t, s, i]) {
    const o = Wi(e), { values: n, keys: r } = this.dt(t, s, i);
    if (!Array.isArray(o)) return this.ut = r, n;
    const a = this.ut ?? (this.ut = []), c = [];
    let d, p, u = 0, g = o.length - 1, y = 0, f = n.length - 1;
    for (; u <= g && y <= f; ) if (o[u] === null) u++;
    else if (o[g] === null) g--;
    else if (a[u] === r[y]) c[y] = ct(o[u], n[y]), u++, y++;
    else if (a[g] === r[f]) c[f] = ct(o[g], n[f]), g--, f--;
    else if (a[u] === r[f]) c[f] = ct(o[u], n[f]), Tt(e, c[f + 1], o[u]), u++, f--;
    else if (a[g] === r[y]) c[y] = ct(o[g], n[y]), Tt(e, o[u], o[g]), g--, y++;
    else if (d === void 0 && (d = Us(r, y, f), p = Us(a, u, g)), d.has(a[u])) if (d.has(a[g])) {
      const m = p.get(r[y]), b = m !== void 0 ? o[m] : null;
      if (b === null) {
        const _ = Tt(e, o[u]);
        ct(_, n[y]), c[y] = _;
      } else c[y] = ct(b, n[y]), Tt(e, o[u], b), o[m] = null;
      y++;
    } else ne(o[g]), g--;
    else ne(o[u]), u++;
    for (; y <= f; ) {
    ...
    return this.ut = r, Ki(e, c), yt;
  }
});
var qi = Object.defineProperty, Yi = Object.getOwnPropertyDescriptor, U = (e, t, s, i) => {
...
function ci(e, t, s) {
  ...
  if (o)
    ...
    const a = !!n, c = !!r;
    if (!a && !c) return null;
    const d = a ? re(s, n) : null, p = c ? re(s, r) : null;
    if ((!a || d === null) && (!c || p === null)) return null;
    i = (d ?? 0) - (p ?? 0);
  }
...
function to(e, t) {
  ...
  for (let n = 0; n < 24; n++) {
    ...
    for (let p = 0; p < e.length; p++) {
      const u = new Date(e[p].last_changed).getTime(), g = p + 1 < e.length ? new Date(e[p + 1].last_changed).getTime() : s, y = Math.max(u, r), f = Math.min(g, a);
      if (f <= y) continue;
...
let G = class extends j {
    ...
    if (!(!this.hass || !t.length && !s.length && !i.length)) {
      ...
      try {
        const r = /* @__PURE__ */ new Date(), a = new Date(r.getTime() - 864e5), c = async (d) => Promise.all(
          d.map(async (p) => {
            var f, m;
            const u = `history/period/${a.toISOString()}?filter_entity_id=${p}&minimal_response=true&no_attributes=true&end_time=${r.toISOString()}`, g = await this.hass.callApi("GET", u), y = (m = (f = this.hass.states) == null ? void 0 : f[p]) == null ? void 0 : m.attributes.unit_of_measurement;
  ...
  async _loadGridMoney() {
    ...
    try {
      const [C, T, P, O] = await Promise.all([
        ...
        st
      ), ot = so(this.hass.states, t.cost_entity), K = et ?? ot, W = it ?? (Q !== null && Y !== null ? Q * Y : null), nt = K !== null && W !== null ? K - W : null;
      this._gridMoney = {
        importCostToday: K,
  ...
  _powerSubtitle(e, t, s) {
    ...
    const o = this.hass.states, n = ((H = (z = this.config) == null ? void 0 : z.entity_types) == null ? void 0 : H.solar) ?? {}, r = ((D = (R = this.config) == null ? void 0 : R.entity_types) == null ? void 0 : D.home) ?? {}, a = ((F = (V = this.config) == null ? void 0 : V.entity_types) == null ? void 0 : F.battery) ?? {}, c = ut("solar", n, o), d = ut("home", r, o), p = ut("battery", a, o), u = e.magnitude ?? 0;
    if (u <= 0) return i;
    const g = c.direction === "to-home" ? c.magnitude ?? 0 : 0, y = Math.max(d.power ?? 0, 0), f = p.direction === "to-home" ? p.magnitude ?? 0 : 0, m = Math.max(g - y, 0), b = Math.min(u, m), _ = Math.min(
      Math.max(u - b, 0),
      f
    ), S = b + _;
    if (Math.max(u - S, 0) > Math.max(lt, u * 0.1))
      return i;
    ...
    return !d && !c.length && p === null && u === null && g === null ? v : w`
      <div class="section">
        ...
        ${c.length ? w`
          ...
          ${c.map((_) => {
      const S = _.start ?? _.start_time ?? "", k = _.end ?? _.end_time ?? "", C = _.value_inc_vat ?? _.rate_inc_vat ?? _.value ?? 0, T = co(C);
      return w`
              <div class="slot">
  ...
  _sectionChart(e) {
    const t = this._hourly.filter((n) => n !== null), s = t.length ? Math.max(...t) : 0, i = /* @__PURE__ */ new Date(), o = (n) => ao(new Date(i.getTime() - n * 36e5));
  ...
  render() {
    ...
    const e = ((d = (c = this.config) == null ? void 0 : c.entity_types) == null ? void 0 : d[this.nodeType]) ?? {}, t = ((p = this.hass) == null ? void 0 : p.states) ?? {}, s = e.colour || ((u = oi[this.nodeType]) == null ? void 0 : u.accent) || ni.accent, i = e.icon || Ji[this.nodeType] || "mdi:lightning-bolt", o = e.label || this.nodeType.charAt(0).toUpperCase() + this.nodeType.slice(1), n = ut(this.nodeType, e, t), r = !!e.soc && (["battery", "ev"].includes(this.nodeType) || !Jt.includes(this.nodeType)), a = r ? eo(t, e.soc) : null;
    return w`
      <div
        class="overlay"
...
var ho = Object.defineProperty, uo = Object.getOwnPropertyDescriptor, Ut = (e, t, s, i) => {
  for (var o = i > 1 ? void 0 : i ? uo(t, s) : t, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (o = (i ? r(t, s, o) : r(o)) || o);
...
let mt = class extends j {
  ...
  _flowInfo(e) {
    var r, a, c, d, p, u;
    const t = ((a = (r = this.config) == null ? void 0 : r.entity_types) == null ? void 0 : a[e]) ?? {}, s = ((c = this.hass) == null ? void 0 : c.states) ?? {};
    if (e !== "home")
      return ut(e, t, s);
    const i = ci("home", t, s);
    if (i === null) return le("home", null, t.zero_tolerance ?? 0);
    const o = (d = this.config) != null && d.ev_subtract_from_home ? ut("ev", ((u = (p = this.config) == null ? void 0 : p.entity_types) == null ? void 0 : u.ev) ?? {}, s).power ?? 0 : 0, n = this._customTypes().reduce((g, y) => {
      var b, _;
  ...
  _computeLineVisualState(e) {
    ...
    return {
      color: q[e] ?? ((u = (p = (d = this.config) == null ? void 0 : d.entity_types) == null ? void 0 : p[e]) == null ? void 0 : u.colour) ?? "#9e9e9e",
  ...
  _svgLines() {
    ...
    const i = [], o = [], n = ($, M, I, B, _t) => {
      fo.has($) || !e[M] || !e[I] || o.push({
        key: `idle-${$}`,
        pathKey: $,
        from: M,
        to: I,
    ...
    }, r = this._flowInfo("solar"), a = this._flowInfo("home"), c = this._flowInfo("battery"), d = this._flowInfo("ev"), p = this._flowInfo("grid"), u = s && r.direction === "to-home" ? r.magnitude ?? 0 : 0, g = Math.max(a.power ?? 0, 0), y = c.direction === "from-home" ? c.magnitude ?? 0 : 0, f = c.direction === "to-home" ? c.magnitude ?? 0 : 0, m = d.direction === "from-home" ? d.magnitude ?? 0 : 0, b = p.direction === "from-home" ? p.magnitude ?? 0 : 0, _ = Math.min(u, g);
    ...
    return Mt`
      ...
      ($) => {
        ...
        if (!M || !I) return v;
        const B = this._lineVisualState[$.type] ?? this._computeLineVisualState($.type), _t = [
          "flow-line",
          "magnitude" in $ ? "" : "idle",
          B.paused ? "paused" : ""
        ].filter(Boolean).join(" ");
  ...
  _node(e, t, s = !1) {
    var c, d, p;
    const i = e === "home" ? !0 : this._isVisible(e), o = ((d = (c = this.config) == null ? void 0 : c.entity_types) == null ? void 0 : d[e]) ?? {}, n = ((p = this.config) == null ? void 0 : p.display) ?? {}, r = this._flowInfo(e), a = e === "solar" ? Bs(this._dailyKwh(e), n.decimal_places ?? 1) : "";
    return w`
      <hec-energy-node
        data-node-type=${e}
        class="${t}${i ? "" : " hidden"}"
  ...
  _customNode(e, t, s, i) {
    var d, p, u;
    const o = this._isVisible(e), n = ((p = (d = this.config) == null ? void 0 : d.entity_types) == null ? void 0 : p[e]) ?? {}, r = ((u = this.config) == null ? void 0 : u.display) ?? {}, a = this._flowInfo(e), c = Bs(
      this._dailyKwh(e),
      r.decimal_places ?? 1
    );
    return w`
  ...
  render() {
    ...
    return w`
      <div class="grid" @hec-node-click=${this._onNodeClick}>
        ...
        ${Vs(s, ({ type: i }) => i, ({ type: i, slotIndex: o }) => {
      const [n, r] = this._customSlot(o);
      return this._customNode(i, n, r, o);
    })}
      </div>
...
Ut([
  Dt()
], mt.prototype, "_dialogType", 2);
Ut([
  Dt()
], mt.prototype, "_lineLayout", 2);
mt = Ut([
  Et("hec-flow-layout")
], mt);
var yo = Object.defineProperty, go = Object.getOwnPropertyDescriptor, _e = (e, t, s, i) => {
  for (var o = i > 1 ? void 0 : i ? go(t, s) : t, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (o = (i ? r(t, s, o) : r(o)) || o);
