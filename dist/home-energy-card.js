 ...
 */
const Vt = globalThis, re = Vt.ShadowRoot && (Vt.ShadyCSS === void 0 || Vt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ae = Symbol(), bs = /* @__PURE__ */ new WeakMap();
let Ws = class {
  constructor(t, s, i) {
...
const si = (e) => new Ws(typeof e == "string" ? e : e + "", void 0, ae), bt = (e, ...t) => {
  const s = e.length === 1 ? e[0] : t.reduce((i, o, n) => i + ((r) => {
    if (r._$cssResult$ === !0) return r.cssText;
    if (typeof r == "number") return r;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(o) + e[n + 1], e[0]);
  return new Ws(s, e, ae);
}, ii = (e, t) => {
  if (re) e.adoptedStyleSheets = t.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet);
...
}, ws = re ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let s = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: oi, defineProperty: ni, getOwnPropertyDescriptor: ri, getOwnPropertyNames: ai, getOwnPropertySymbols: ci, getPrototypeOf: li } = Object, Z = globalThis, $s = Z.trustedTypes, hi = $s ? $s.emptyScript : "", Xt = Z.reactiveElementPolyfillSupport, At = (e, t) => e, Kt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? hi : null;
      break;
  ...
  return s;
} }, ce = (e, t) => !oi(e, t), xs = { attribute: !0, type: String, converter: Kt, reflect: !1, useDefault: !1, hasChanged: ce };
...
let yt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, s, i) {
    const { get: o, set: n } = ri(this.prototype, t) ?? { get() {
      return this[s];
    }, set(r) {
      this[s] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(At("properties"))) {
      const s = this.properties, i = [...ai(s), ...ci(s)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of i) s.unshift(ws(o));
    } else t !== void 0 && s.push(ws(t));
    return s;
  }
  static _$Eu(t, s) {
    const i = s.attribute;
  ...
  _$ET(t, s) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (((n = i.converter) == null ? void 0 : n.toAttribute) !== void 0 ? i.converter : Kt).toAttribute(s, i.type);
  ...
  _$AK(t, s) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = i.getPropertyOptions(o), l = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((n = a.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? a.converter : Kt;
      this._$Em = o;
  ...
  requestUpdate(t, s, i, o = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (o === !1 && (n = this[t]), i ?? (i = a.getPropertyOptions(t)), !((i.hasChanged ?? ce)(n, s) || i.useDefault && i.reflect && n === ((r = this._$Ej) == null ? void 0 : r.get(t)) && !this.hasAttribute(a._$Eu(t, i)))) return;
      this.C(t, s, i);
    }
...
yt.elementStyles = [], yt.shadowRootOptions = { mode: "open" }, yt[At("elementProperties")] = /* @__PURE__ */ new Map(), yt[At("finalized")] = /* @__PURE__ */ new Map(), Xt == null || Xt({ ReactiveElement: yt }), (Z.reactiveElementVersions ?? (Z.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Tt = globalThis, Es = (e) => e, Wt = Tt.trustedTypes, Cs = Wt ? Wt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, qs = "$lit$", Y = `lit$${Math.random().toFixed(9).slice(2)}$`, Ys = "?" + Y, di = `<${Ys}>`, dt = document, Pt = () => dt.createComment(""), Mt = (e) => e === null || typeof e != "object" && typeof e != "function", le = Array.isArray, ui = (e) => le(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Jt = `[ 	
\f\r]`, Ct = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ss = /-->/g, As = />/g, nt = RegExp(`>|${Jt}(?:([^\\s"'>=/]+)(${Jt}*=${Jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ts = /'/g, ks = /"/g, Zs = /^(?:script|style|textarea|title)$/i, Xs = (e) => (t, ...s) => ({ _$litType$: e, strings: t, values: s }), w = Xs(1), kt = Xs(2), ut = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), Ps = /* @__PURE__ */ new WeakMap(), lt = dt.createTreeWalker(dt, 129);
function Js(e, t) {
...
const pi = (e, t) => {
  ...
  for (let a = 0; a < s; a++) {
    const l = e[a];
    let d, p, u = -1, y = 0;
    for (; y < l.length && (r.lastIndex = y, p = r.exec(l), p !== null); ) y = r.lastIndex, r === Ct ? p[1] === "!--" ? r = Ss : p[1] !== void 0 ? r = As : p[2] !== void 0 ? (Zs.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = nt) : p[3] !== void 0 && (r = nt) : r === nt ? p[0] === ">" ? (r = o ?? Ct, u = -1) : p[1] === void 0 ? u = -2 : (u = r.lastIndex - p[2].length, d = p[1], r = p[3] === void 0 ? nt : p[3] === '"' ? ks : Ts) : r === ks || r === Ts ? r = nt : r === Ss || r === As ? r = Ct : (r = nt, o = void 0);
    const g = r === nt && e[a + 1].startsWith("/>") ? " " : "";
    n += r === Ct ? l + di : u >= 0 ? (i.push(d), l.slice(0, u) + qs + l.slice(u) + Y + g) : l + Y + (u === -2 ? a : g);
  }
  return [Js(e, n + (e[s] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class Lt {
  constructor({ strings: t, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, r = 0;
    const a = t.length - 1, l = this.parts, [d, p] = pi(t, s);
    ...
    for (; (o = lt.nextNode()) !== null && l.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const u of o.getAttributeNames()) if (u.endsWith(qs)) {
          ...
          l.push({ type: 1, index: n, name: f[2], strings: g, ctor: f[1] === "." ? gi : f[1] === "?" ? yi : f[1] === "@" ? mi : Zt }), o.removeAttribute(u);
        ...
        if (Zs.test(o.tagName)) {
          ...
          if (y > 0) {
            o.textContent = Wt ? Wt.emptyScript : "";
...
class fi {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (r === l.index) {
        let d;
        l.type === 2 ? d = new wt(n, n.nextSibling, this, t) : l.type === 1 ? d = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (d = new _i(n, this, t)), this._$AV.push(d), l = i[++a];
      }
...
class wt {
  ...
  _$AI(t, s = this) {
    t = vt(this, t, s), Mt(t) ? t === v || t == null || t === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : t !== this._$AH && t !== ut && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ui(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    var n;
    const { values: s, _$litType$: i } = t, o = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = Lt.createElement(Js(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(s);
    else {
      const r = new fi(o, this), a = r.u(this.options);
      r.p(s), this.T(a), this._$AH = r;
    }
  }
  _$AC(t) {
    let s = Ps.get(t.strings);
    return s === void 0 && Ps.set(t.strings, s = new Lt(t)), s;
  }
  k(t) {
...
const vi = { I: wt }, Qt = Tt.litHtmlPolyfillSupport;
Qt == null || Qt(Lt, wt), (Tt.litHtmlVersions ?? (Tt.litHtmlVersions = [])).push("3.3.2");
const bi = (e, t, s) => {
...
let B = class extends yt {
  ...
  update(t) {
    const s = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = bi(s, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var Ks;
B._$litElement$ = !0, B.finalized = !0, (Ks = ht.litElementHydrateSupport) == null || Ks.call(ht, { LitElement: B });
const te = ht.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const wi = { attribute: !0, type: String, converter: Kt, reflect: !1, hasChanged: ce }, $i = (e = wi, t, s) => {
...
function x(e) {
  return (t, s) => typeof s == "object" ? $i(e, t, s) : ((i, o, n) => {
...
const he = (e) => e.attributes.device_class ?? "", de = (e) => e.attributes.unit_of_measurement ?? "", ue = (e, t) => e.toLowerCase() + " " + (t.attributes.friendly_name ?? "").toLowerCase();
function ct(...e) {
  return (t, s) => {
    let i = 0;
    he(s) === "power" && (i += 4), ["W", "kW"].includes(de(s)) && (i += 2);
    const o = ue(t, s);
...
function mt(...e) {
  return (t, s) => {
    let i = 0;
    he(s) === "energy" && (i += 4), ["kWh", "Wh", "MWh"].includes(de(s)) && (i += 2);
    const o = ue(t, s);
    for (const n of e) o.includes(n) && (i += 1);
    return i;
  };
...
function xi(e, t, s) {
  ...
  const n = o.filter(
    ...
    n,
    e,
    It(["_current_rate"], ["export", "accumulative"]),
    s
  );
...
function Ci(e) {
  var l, d;
  const t = e, s = t.states ?? {}, i = t.entities ?? {}, o = /* @__PURE__ */ new Set(), n = Ei(s, i, o), r = xi(s, i, o), a = {
...
const qt = ["grid", "solar", "battery", "home", "ev"], Ai = "custom_", Bt = 4;
function Ls(e) {
...
function jt(e) {
  ...
  ), i = Object.entries(t).filter(([r]) => !qt.includes(r)).sort(([r], [a]) => Ls(r) - Ls(a)).map(([, r]) => ({ ...r })), o = Array.isArray(e.custom_types) ? e.custom_types.map((r) => ({ ...r })) : i, n = {
    ...s
  };
...
var ki = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, pe = (e, t, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Pi(t, s) : t, n = e.length - 1, r; n >= 0; n--)
...
let Ot = class extends B {
  ...
  _addCustomType() {
    var t, s, i;
    if ((((s = (t = this.config) == null ? void 0 : t.custom_types) == null ? void 0 : s.length) ?? 0) >= Bt) return;
  ...
  render() {
    var i, o, n, r, a, l, d, p, u, y, g, f, m, b, _, S, k, C, T, P, L, O, z, H, R, U, F, xt, J, q, Q, tt, et, st, it, G, K, ot, Et, $, M, I, V, gt, ge, ye, me, _e, ve, be, we, $e, xe, Ee, Ce, Se, Ae, Te, ke, Pe, Me, Le, Oe, Ne, ze, He, Re, Ie, De, Ue, Fe, Ve, Be, je, Ge, Ke, We, qe, Ye, Ze, Xe, Je, Qe, ts, es, ss, is, os, ns, rs, as, cs, ls, hs, ds, us, ps, fs, gs, ys, ms, _s;
    if (!this.config) return v;
    const e = this.config.custom_types ?? [], t = e.slice(0, Bt), s = e.length >= Bt;
    return w`
      ...
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((y = (u = this.config.entity_types) == null ? void 0 : u.grid) == null ? void 0 : y.export_rate) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((f = (g = this.config.entity_types) == null ? void 0 : g.grid) == null ? void 0 : f.show_zero) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ icon: {} }}
            .value=${((O = (L = this.config.entity_types) == null ? void 0 : L.grid) == null ? void 0 : O.icon) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="Grid Colour"
            .value=${((H = (z = this.config.entity_types) == null ? void 0 : z.grid) == null ? void 0 : H.colour) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      <ha-expansion-panel header="Solar">
        <div class="section-body">
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((U = (R = this.config.entity_types) == null ? void 0 : R.solar) == null ? void 0 : U.power_combined) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((xt = (F = this.config.entity_types) == null ? void 0 : F.solar) == null ? void 0 : xt.daily_usage) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((q = (J = this.config.entity_types) == null ? void 0 : J.solar) == null ? void 0 : q.show_zero) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            ...
            type="number"
            min="0"
            .value=${((tt = (Q = this.config.entity_types) == null ? void 0 : Q.solar) == null ? void 0 : tt.zero_tolerance) != null ? String((st = (et = this.config.entity_types) == null ? void 0 : et.solar) == null ? void 0 : st.zero_tolerance) : ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            <span>Show Label</span>
            <ha-switch
              .checked=${((G = (it = this.config.entity_types) == null ? void 0 : it.solar) == null ? void 0 : G.show_label) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="Solar Label"
            .value=${((ot = (K = this.config.entity_types) == null ? void 0 : K.solar) == null ? void 0 : ot.label) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ icon: {} }}
            .value=${(($ = (Et = this.config.entity_types) == null ? void 0 : Et.solar) == null ? void 0 : $.icon) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      <ha-expansion-panel header="Battery">
        <div class="section-body">
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((gt = (V = this.config.entity_types) == null ? void 0 : V.battery) == null ? void 0 : gt.soc) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((ye = (ge = this.config.entity_types) == null ? void 0 : ge.battery) == null ? void 0 : ye.power_combined) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((_e = (me = this.config.entity_types) == null ? void 0 : me.battery) == null ? void 0 : _e.daily_usage) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((be = (ve = this.config.entity_types) == null ? void 0 : ve.battery) == null ? void 0 : be.show_zero) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            ...
            type="number"
            min="0"
            .value=${(($e = (we = this.config.entity_types) == null ? void 0 : we.battery) == null ? void 0 : $e.zero_tolerance) != null ? String((Ee = (xe = this.config.entity_types) == null ? void 0 : xe.battery) == null ? void 0 : Ee.zero_tolerance) : ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((Se = (Ce = this.config.entity_types) == null ? void 0 : Ce.battery) == null ? void 0 : Se.reverse_power_flow) ?? !1}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            <span>Show Label</span>
            <ha-switch
              .checked=${((Te = (Ae = this.config.entity_types) == null ? void 0 : Ae.battery) == null ? void 0 : Te.show_label) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="Battery Label"
            .value=${((Pe = (ke = this.config.entity_types) == null ? void 0 : ke.battery) == null ? void 0 : Pe.label) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ icon: {} }}
            .value=${((Le = (Me = this.config.entity_types) == null ? void 0 : Me.battery) == null ? void 0 : Le.icon) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            ...
            .value=${((Ne = (Oe = this.config.entity_types) == null ? void 0 : Oe.battery) == null ? void 0 : Ne.colour) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      <ha-expansion-panel header="Home">
        <div class="section-body">
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((He = (ze = this.config.entity_types) == null ? void 0 : ze.home) == null ? void 0 : He.power_combined) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((Ie = (Re = this.config.entity_types) == null ? void 0 : Re.home) == null ? void 0 : Ie.daily_usage) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((Ue = (De = this.config.entity_types) == null ? void 0 : De.home) == null ? void 0 : Ue.show_zero) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            ...
            type="number"
            min="0"
            .value=${((Ve = (Fe = this.config.entity_types) == null ? void 0 : Fe.home) == null ? void 0 : Ve.zero_tolerance) != null ? String((je = (Be = this.config.entity_types) == null ? void 0 : Be.home) == null ? void 0 : je.zero_tolerance) : ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            <span>Show Label</span>
            <ha-switch
              .checked=${((Ke = (Ge = this.config.entity_types) == null ? void 0 : Ge.home) == null ? void 0 : Ke.show_label) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="Home Label"
            .value=${((qe = (We = this.config.entity_types) == null ? void 0 : We.home) == null ? void 0 : qe.label) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ icon: {} }}
            .value=${((Ze = (Ye = this.config.entity_types) == null ? void 0 : Ye.home) == null ? void 0 : Ze.icon) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="Home Colour"
            .value=${((Je = (Xe = this.config.entity_types) == null ? void 0 : Xe.home) == null ? void 0 : Je.colour) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      <ha-expansion-panel header="EV">
        <div class="section-body">
          <ha-selector
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((ts = (Qe = this.config.entity_types) == null ? void 0 : Qe.ev) == null ? void 0 : ts.power_combined) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((ss = (es = this.config.entity_types) == null ? void 0 : es.ev) == null ? void 0 : ss.soc) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ entity: {} }}
            .value=${((os = (is = this.config.entity_types) == null ? void 0 : is.ev) == null ? void 0 : os.daily_usage) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            ...
            <ha-switch
              .checked=${((rs = (ns = this.config.entity_types) == null ? void 0 : ns.ev) == null ? void 0 : rs.show_zero) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            ...
            type="number"
            min="0"
            .value=${((cs = (as = this.config.entity_types) == null ? void 0 : as.ev) == null ? void 0 : cs.zero_tolerance) != null ? String((hs = (ls = this.config.entity_types) == null ? void 0 : ls.ev) == null ? void 0 : hs.zero_tolerance) : ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <div class="switch-row">
            <span>Show Label</span>
            <ha-switch
              .checked=${((us = (ds = this.config.entity_types) == null ? void 0 : ds.ev) == null ? void 0 : us.show_label) ?? !0}
              @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="EV Label"
            .value=${((fs = (ps = this.config.entity_types) == null ? void 0 : ps.ev) == null ? void 0 : fs.label) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-selector
            ...
            .hass=${this.hass}
            .selector=${{ icon: {} }}
            .value=${((ys = (gs = this.config.entity_types) == null ? void 0 : gs.ev) == null ? void 0 : ys.icon) ?? ""}
            @value-changed=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
          ...
          <ha-textfield
            label="EV Colour"
            .value=${((_s = (ms = this.config.entity_types) == null ? void 0 : ms.ev) == null ? void 0 : _s.colour) ?? ""}
            @change=${(h) => {
      var c;
      return this.dispatchEvent(
        new CustomEvent("config-changed", {
      ...
      var vs;
      return w`
        <ha-expansion-panel header=${((vs = h.label) == null ? void 0 : vs.trim()) || `Custom ${c + 1}`}>
          <div class="section-body">
            <button
...
var Mi = Object.defineProperty, Li = Object.getOwnPropertyDescriptor, Ht = (e, t, s, i) => {
...
let pt = class extends B {
  ...
  render() {
    var _, S, k, C, T, P, L, O, z, H, R;
    if (!this.config) return v;
    const e = ((_ = this.hass) == null ? void 0 : _.states) ?? {}, t = this.config.entity_types ?? {}, s = ((S = this.config.display) == null ? void 0 : S.decimal_places) ?? 1, i = this.config.tariff_entity ? (k = e[this.config.tariff_entity]) == null ? void 0 : k.state : null, o = i && i !== "unavailable" && i !== "unknown" ? Oi(i) : null, n = Dt(e, (C = t.solar) == null ? void 0 : C.daily_usage), r = Dt(e, (T = t.home) == null ? void 0 : T.daily_usage), a = Dt(e, (P = t.grid) == null ? void 0 : P.daily_usage), l = Dt(e, (L = t.grid) == null ? void 0 : L.daily_export), d = !!((O = t.solar) != null && O.daily_usage), p = !!((z = t.home) != null && z.daily_usage), u = !!((H = t.grid) != null && H.daily_usage), y = !!((R = t.grid) != null && R.daily_export), g = u || y, f = d || p || g, m = this.showValues && f, b = this.showTitle || o;
    return !b && !m ? v : w`
      <div class="header">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ni = { CHILD: 2 }, zi = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Hi = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Ri } = vi, Os = (e) => e, Ns = () => document.createComment(""), St = (e, t, s) => {
  var n;
  const i = e._$AA.parentNode, o = t === void 0 ? e._$AB : t._$AA;
  if (s === void 0) {
    const r = i.insertBefore(Ns(), o), a = i.insertBefore(Ns(), o);
    s = new Ri(r, a, e, e.options);
  } else {
    ...
    if (r !== o || l) {
      let d = s._$AA;
      for (; d !== r; ) {
        const p = Os(d).nextSibling;
        Os(i).insertBefore(d, o), d = p;
      }
    }
  }
  return s;
}, rt = (e, t, s = e) => (e._$AI(t, s), e), Ii = {}, Di = (e, t = Ii) => e._$AH = t, Ui = (e) => e._$AH, ee = (e) => {
...
const zs = (e, t, s) => {
  ...
  update(e, [t, s, i]) {
    const o = Ui(e), { values: n, keys: r } = this.dt(t, s, i);
    ...
    else if (d === void 0 && (d = zs(r, g, f), p = zs(a, u, y)), d.has(a[u])) if (d.has(a[y])) {
    ...
    return this.ut = r, Di(e, l), ut;
  }
});
var Fi = Object.defineProperty, Vi = Object.getOwnPropertyDescriptor, D = (e, t, s, i) => {
...
}, oe = 38, Rs = +(2 * Math.PI * oe).toFixed(4);
function Gt(e, t, s) {
  if (e === null) return "—";
  const i = Math.abs(e);
...
let N = class extends B {
  ...
  render() {
    const e = Bi[this.type] ?? ji, t = this.colour || e.accent, s = this.icon || e.icon, i = this.soc !== null, o = this.type === "grid" || this.type === "battery", n = o && this.power !== null ? Math.abs(this.power) : this.power, r = o && this.power !== null ? this.type === "grid" ? this.power > 0 ? "mdi:arrow-right-bold-circle" : this.power < 0 ? "mdi:arrow-left-bold-circle" : "" : this.power > 0 ? "mdi:arrow-left-bold-circle" : this.power < 0 ? "mdi:arrow-right-bold-circle" : "" : "", a = i ? Math.max(0, Math.min(100, this.soc)) : 0, l = +(Rs * (1 - a / 100)).toFixed(4);
    return w`
      <div class="node-wrap">
        ...
        <svg
          ...
          aria-hidden="true"
        >
          <circle class="ring-track"    cx="42" cy="42" r="${oe}"/>
          <circle
            class="ring-progress"
            cx="42" cy="42" r="${oe}"
            style="stroke-dasharray:${Rs};stroke-dashoffset:${l};"
          />
        </svg>
        ...
        >
          ...
          <span class="power">${Gt(n, this.unit, this.decimalPlaces)}</span>
...
function ti(e, t, s) {
  let i;
  if (t.power_combined)
    i = se(s, t.power_combined);
  else {
    const o = !!t.power_import, n = !!t.power_export;
    if (!o && !n) return null;
    const r = o ? se(s, t.power_import) : null, a = n ? se(s, t.power_export) : null;
...
var Gi = Object.defineProperty, Ki = Object.getOwnPropertyDescriptor, X = (e, t, s, i) => {
...
function Us(e) {
  ...
  return (e.attributes.rates ?? e.attributes.current_day_rates ?? e.attributes.today_rates ?? e.attributes.upcoming_interval_rates ?? []).map((i) => {
    const o = new Date(i.start ?? i.start_time ?? "").getTime(), n = new Date(i.end ?? i.end_time ?? "").getTime(), r = Yt(
...
function Fs(e, t, s) {
  ...
  for (let o = 0; o < e.length; o++) {
    const n = new Date(e[o].last_changed).getTime(), r = o + 1 < e.length ? new Date(e[o + 1].last_changed).getTime() : s, a = Yt(e[o].state, t);
    !Number.isFinite(n) || !Number.isFinite(r) || r <= n || a !== null && i.push({ startMs: n, endMs: r, rateGbpPerKwh: a });
  }
  return i;
}
function Ji(e, t) {
  const s = t == null ? void 0 : t.attributes.unit_of_measurement, i = e.map((o) => Yt(o.state, s)).filter((o) => o !== null);
  if (i.length > 0) {
    const o = i[0];
    return i.every((n) => Math.abs(n - o) < 1e-9) ? o : null;
  }
  return t ? Yt(t.state, s) : null;
}
function Qi(e, t) {
...
let j = class extends B {
  ...
  async _loadHistory() {
    ...
    try {
      ...
      this._hourly = Zi((p == null ? void 0 : p[0]) ?? [], s);
    } catch (a) {
  ...
  async _loadGridMoney() {
    ...
    ), i = e.export_rate ? (u = this.hass.states) == null ? void 0 : u[e.export_rate] : void 0, o = Us(
      i
    ), n = /* @__PURE__ */ new Date();
    n.setHours(0, 0, 0, 0);
    ...
    try {
      const [C, T, P, L] = await Promise.all([
        ...
        a(t.rate_entity),
        a(e.export_rate)
      ]), O = e.daily_usage ? (g = (y = this.hass.states) == null ? void 0 : y[e.daily_usage]) == null ? void 0 : g.attributes.unit_of_measurement : void 0, z = e.daily_export ? (m = (f = this.hass.states) == null ? void 0 : f[e.daily_export]) == null ? void 0 : m.attributes.unit_of_measurement : void 0, H = t.rate_entity ? (_ = (b = this.hass.states) == null ? void 0 : b[t.rate_entity]) == null ? void 0 : _.attributes.unit_of_measurement : void 0, R = e.export_rate ? (k = (S = this.hass.states) == null ? void 0 : S[e.export_rate]) == null ? void 0 : k.attributes.unit_of_measurement : void 0, U = s.length ? s : Fs(P, H, r.getTime()), F = o.length ? o : Fs(L, R, r.getTime()), xt = Ft(this.hass.states, e.daily_usage), J = Ft(this.hass.states, e.daily_export), q = Ji(L, i), Q = Vs(
        C,
        O,
        U
      ), tt = Bs(
        ...
        et
      ), it = Xi(this.hass.states, t.cost_entity), G = tt ?? it, K = st ?? (J !== null && q !== null ? J * q : null), ot = G !== null && K !== null ? G - K : null;
      this._gridMoney = {
        importCostToday: G,
  ...
  _sectionPower(e) {
    ...
    return w`
      <div class="section">
        ...
        <div class="power-big">${Gt(e.power, s, t)}</div>
  ...
  _powerSubtitle(e, t, s) {
    var L, O, z, H, R, U, F;
    const i = ((L = Yi[this.nodeType]) == null ? void 0 : L[e.direction]) ?? "";
    if (this.nodeType !== "grid" || e.direction !== "from-home" || !this.hass) return i;
    const o = this.hass.states, n = ((z = (O = this.config) == null ? void 0 : O.entity_types) == null ? void 0 : z.solar) ?? {}, r = ((R = (H = this.config) == null ? void 0 : H.entity_types) == null ? void 0 : R.home) ?? {}, a = ((F = (U = this.config) == null ? void 0 : U.entity_types) == null ? void 0 : F.battery) ?? {}, l = _t("solar", n, o), d = _t("home", r, o), p = _t("battery", a, o), u = e.magnitude ?? 0;
    if (u <= 0) return i;
    ...
    return C ? "Exporting solely from excess solar production" : T ? "Exporting solely from the battery" : P ? `Exporting ${Gt(b, t, s)} from excess solar production and ${Gt(_, t, s)} from the battery` : i;
  }
  _sectionSoc(e) {
    if (e === null) return v;
    const t = so(e);
  ...
  _sectionDaily(e) {
    ...
    return e.daily_usage && n.push([i, Ds(Ft(t, e.daily_usage), s)]), e.daily_export && n.push([o, Ds(Ft(t, e.daily_export), s)]), n.length ? w`
      <div class="section">
    ...
    return !d && !l.length && p === null && u === null && y === null ? v : w`
      <div class="section">
        ...
        <div class="kv">
          ...
          <span class="kv-v">${ie(p)}</span>
        </div>

        <div class="kv">
          <span class="kv-k">Export Payment Today</span>
          <span class="kv-v">${ie(u)}</span>
        </div>

        <div class="kv">
          <span class="kv-k">Net Cost</span>
          <span class="kv-v">${ie(y)}</span>
        </div>

        ${l.length ? w`
          <div class="s-subtitle">Upcoming slots</div>
          ${l.map((_) => {
      const S = _.start ?? _.start_time ?? "", k = _.end ?? _.end_time ?? "", C = _.value_inc_vat ?? _.rate_inc_vat ?? _.value ?? 0, T = eo(C);
      return w`
              <div class="slot">
                <span class="slot-dot" style="background:${T};"></span>
                <span class="slot-time">${js(S)}–${js(k)}</span>
  ...
  _sectionChart(e) {
    const t = this._hourly.filter((n) => n !== null), s = t.length ? Math.max(...t) : 0, i = /* @__PURE__ */ new Date(), o = (n) => to(new Date(i.getTime() - n * 36e5));
  ...
  render() {
    ...
    const e = ((d = (l = this.config) == null ? void 0 : l.entity_types) == null ? void 0 : d[this.nodeType]) ?? {}, t = ((p = this.hass) == null ? void 0 : p.states) ?? {}, s = e.colour || (qi[this.nodeType] ?? "#9e9e9e"), i = e.icon || Wi[this.nodeType] || "mdi:lightning-bolt", o = e.label || this.nodeType.charAt(0).toUpperCase() + this.nodeType.slice(1), n = _t(this.nodeType, e, t), r = !!e.soc && (["battery", "ev"].includes(this.nodeType) || !qt.includes(this.nodeType)), a = r ? ei(t, e.soc) : null;
    return w`
      <div
        class="overlay"
...
var io = Object.defineProperty, oo = Object.getOwnPropertyDescriptor, Rt = (e, t, s, i) => {
...
let ft = class extends B {
  ...
  _flowInfo(e) {
    ...
    if (e !== "home")
      return _t(e, t, s);
    const i = ti("home", t, s);
    if (i === null) return ne("home", null, t.zero_tolerance ?? 0);
  ...
  _svgLines() {
    ...
    const i = [], o = [], n = ($, M, I, V, gt) => {
      ro.has($) || !e[M] || !e[I] || o.push({
        key: `idle-${$}`,
        pathKey: $,
        from: M,
        to: I,
    ...
    const P = Math.max(g - k, 0), L = Math.max(m - C, 0), O = Math.max(b - T, 0), z = Math.max(y - _, 0), H = Math.min(f, z), R = Math.max(f - H, 0), U = Math.min(O, R), F = O <= Gs || U <= Gs ? 0 : U;
    ...
    for (const $ of this._customTypes()) {
      const M = this._flowInfo($), I = e[$], V = ((G = this._lineVisualState[$]) == null ? void 0 : G.color) ?? this._computeLineVisualState($).color;
      I && n(`home-${$}`, "home", $, $, V), !(!I || !M.magnitude || M.direction === "idle") && i.push({
        key: `custom-${$}`,
        pathKey: `home-${$}`,
    ...
    const xt = new Set(i.map(($) => $.pathKey)), J = [
  ...
  _node(e, t, s = !1) {
    var l, d, p;
    const i = e === "home" ? !0 : this._isVisible(e), o = ((d = (l = this.config) == null ? void 0 : l.entity_types) == null ? void 0 : d[e]) ?? {}, n = ((p = this.config) == null ? void 0 : p.display) ?? {}, r = this._flowInfo(e), a = e === "solar" ? Is(this._dailyKwh(e), n.decimal_places ?? 1) : "";
    return w`
      <hec-energy-node
        data-node-type=${e}
        class="${t}${i ? "" : " hidden"}"
  ...
  _customNode(e, t, s) {
    var l, d, p;
    const i = this._isVisible(e), o = ((d = (l = this.config) == null ? void 0 : l.entity_types) == null ? void 0 : d[e]) ?? {}, n = ((p = this.config) == null ? void 0 : p.display) ?? {}, r = this._flowInfo(e), a = Is(
      this._dailyKwh(e),
      n.decimal_places ?? 1
    );
    return w`
...
var ao = Object.defineProperty, co = Object.getOwnPropertyDescriptor, fe = (e, t, s, i) => {
  for (var o = i > 1 ? void 0 : i ? co(t, s) : t, n = e.length - 1, r; n >= 0; n--)
    (r = e[n]) && (o = (i ? r(t, s, o) : r(o)) || o);
