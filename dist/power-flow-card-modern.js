 ...
 */
const N = globalThis, B = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, q = Symbol(), Z = /* @__PURE__ */ new WeakMap();
let ot = class {
  constructor(t, e, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ft, defineProperty: _t, getOwnPropertyDescriptor: gt, getOwnPropertyNames: mt, getOwnPropertySymbols: yt, getPrototypeOf: At } = Object, _ = globalThis, K = _.trustedTypes, vt = K ? K.emptyScript : "", D = _.reactiveElementPolyfillSupport, w = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? vt : null;
      break;
  ...
  return e;
} }, V = (r, t) => !ft(r, t), G = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: V };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, Q = (r) => r, j = C.trustedTypes, X = j ? j.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ht = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, at = "?" + f, Et = `<${at}>`, A = document, x = () => A.createComment(""), O = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, bt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Y = /-->/g, tt = />/g, g = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, lt = /^(?:script|style|textarea|title)$/i, St = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), it = St(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), rt = /* @__PURE__ */ new WeakMap(), m = A.createTreeWalker(A, 129);
function ct(r, t) {
...
const wt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); ) u = n.lastIndex, n === S ? p[1] === "!--" ? n = Y : p[1] !== void 0 ? n = tt : p[2] !== void 0 ? (lt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = g) : p[3] !== void 0 && (n = g) : n === g ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? g : p[3] === '"' ? st : et) : n === st || n === et ? n = g : n === Y || n === tt ? n = S : (n = g, i = void 0);
    const $ = n === g && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + Et : l >= 0 ? (s.push(c), h.slice(0, l) + ht + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(ht)) {
          ...
          h.push({ type: 1, index: o, name: T[2], strings: $, ctor: T[1] === "." ? Pt : T[1] === "?" ? xt : T[1] === "@" ? Ot : z }), i.removeAttribute(l);
        ...
        if (lt.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++) i.append(l[$], x()), m.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[u], x());
          }
        }
...
class Ct {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new M(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new Ut(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class M {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), O(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : bt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
k == null || k(U, M), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.2");
const Ht = (r, t, e) => {
...
var nt;
P._$litElement$ = !0, P.finalized = !0, (nt = y.litElementHydrateSupport) == null || nt.call(y, { LitElement: P });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Tt = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: V }, Nt = (r = Tt, t, e) => {
...
var jt = Object.defineProperty, zt = Object.getOwnPropertyDescriptor, F = (r, t, e, s) => {
...
let H = class extends P {
  ...
  render() {
    ...
    const r = this._config.title ?? "Home Energy";
    return it`
      <ha-card>
...
export {
  H as PowerFlowCardModern
};
//# sourceMappingURL=power-flow-card-modern.js.map
